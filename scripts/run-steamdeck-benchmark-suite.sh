...
run_case search-blend-r2 PPFG_LAYER_MODE=search-blend PPFG_SEARCH_BLEND_RADIUS=2
run_case search-adaptive-blend-r1 PPFG_LAYER_MODE=search-adaptive-blend PPFG_SEARCH_BLEND_RADIUS=1
...
run_case reproject-blend-wide PPFG_LAYER_MODE=reproject-blend PPFG_REPROJECT_SEARCH_RADIUS=3 PPFG_REPROJECT_PATCH_RADIUS=2 PPFG_REPROJECT_CONFIDENCE_SCALE=4.0
run_case reproject-adaptive-blend-default PPFG_LAYER_MODE=reproject-adaptive-blend PPFG_REPROJECT_SEARCH_RADIUS=2 PPFG_REPROJECT_PATCH_RADIUS=1 PPFG_REPROJECT_CONFIDENCE_SCALE=4.0
...
run_case adaptive-multi-default PPFG_LAYER_MODE=adaptive-multi-blend PPFG_ADAPTIVE_MULTI_MIN_GENERATED_FRAMES=1 PPFG_ADAPTIVE_MULTI_MAX_GENERATED_FRAMES=2 PPFG_ADAPTIVE_MULTI_INTERVAL_THRESHOLD_MS=5.0
run_case adaptive-multi-target120 PPFG_LAYER_MODE=adaptive-multi-blend PPFG_ADAPTIVE_MULTI_TARGET_FPS=120 PPFG_ADAPTIVE_MULTI_MIN_GENERATED_FRAMES=0 PPFG_ADAPTIVE_MULTI_MAX_GENERATED_FRAMES=2
run_case adaptive-multi-target150 PPFG_LAYER_MODE=adaptive-multi-blend PPFG_ADAPTIVE_MULTI_TARGET_FPS=150 PPFG_ADAPTIVE_MULTI_MIN_GENERATED_FRAMES=0 PPFG_ADAPTIVE_MULTI_MAX_GENERATED_FRAMES=2
run_case adaptive-multi-target180 PPFG_LAYER_MODE=adaptive-multi-blend PPFG_ADAPTIVE_MULTI_TARGET_FPS=180 PPFG_ADAPTIVE_MULTI_MIN_GENERATED_FRAMES=0 PPFG_ADAPTIVE_MULTI_MAX_GENERATED_FRAMES=2
