...
modes=(passthrough clear copy history-copy blend adaptive-blend search-blend search-adaptive-blend reproject-blend reproject-adaptive-blend multi-blend adaptive-multi-blend)
if [[ "${OMFG_LAYER_IMPL}" == "rust" ]]; then
  modes+=(bfi)
fi
